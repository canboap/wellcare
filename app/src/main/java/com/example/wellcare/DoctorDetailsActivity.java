...
public class DoctorDetailsActivity extends AppCompatActivity {
    private String[][] docor_details1 =
            {
            {"Doctor Name : Ajit Saste", "Hospital Address : Pimpri", "Exp : 5yrs", "Mobile No:9898989898", "600"},
            {"Doctor Name : Prasad Pawar", "Hospital Address : Nigdi", "Exp : 15yrs", "Mobile No7898989898", "900" },
    ...
    private String[][] docor_details2 =
            {
                    {"Doctor Name : Neelam Patil", "Hospital Address : Pimpri", "Exp : 5yrs", "Mobile No:9898989898", "600"},
                    {"Doctor Name : Swati Pawar", "Hospital Address : Nigdi", "Exp : 15yrs", "Mobile No7898989898", "900" },
    ...
    private String[][] docor_details3 =
            {
                    {"Doctor Name : Seema Patil", "Hospital Address : Pimpri", "Exp : 4yrs", "Mobile No:9898989898", "200"},
                    {"Doctor Name : Pnkaj Parab", "Hospital Address : Nigdi", "Exp : 15yrs", "Mobile No7898989898", "300" },
    ...
    private String[][] docor_details5 =
            {
                    {"Doctor Name : Nilesh Borate", "Hospital Address : Pimpri", "Exp : 5yrs", "Mobile No:9898989898", "1600"},
                    {"Doctor Name : Pamkaj Pawar", "Hospital Address : Nigdi", "Exp : 15yrs", "Mobile No7898989898", "1900" },
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(title.compareTo("Family Physicians")==0)
            doctor_details = docor_details1;
        else
        if(title.compareTo("Dietician")==0)
            doctor_details = docor_details2;
        else
        if(title.compareTo("Dentist")==0)
            doctor_details = docor_details3;
        else
        if(title.compareTo("Surgeon")==0)
            doctor_details = docor_details4;
        else
            doctor_details = docor_details5;
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            for (int i=0;i<doctor_details.length;i++){
                ...
                item.put("line3", doctor_details[i][1]);
